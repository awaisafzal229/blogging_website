            ...
            <div id="categories">
                ...
                <ul>
                    <?php while ($cats = mysqli_fetch_assoc($query)) { ?>
                        <li>
                            <a class="text-success fw-bold" href="category.php?id=<?= $cats['cat_id'] ?>"><?= $cats['cat_name'] ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </div>
            <div id="posts">
                ...
                <ul>
                    <?php while ($posts = mysqli_fetch_assoc($query2)) { ?>
                        <li>
                            <a class="text-success fw-bold" href="single_post.php?id=<?= $posts['blog_id'] ?>"><?= $posts['blog_title'] ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </div>
